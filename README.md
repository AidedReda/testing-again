...
```sh
npm install git+ssh://git@github.com:stainless-sdks/testingariesmcp-typescript.git
```
...
await client.users.create({ country: 'BfX', email: 'dev@stainless.com', password: 'xxxxxxxx' }, {
  maxRetries: 5,
});
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/testingariesmcp-typescript/issues) with questions, bugs, or suggestions.
