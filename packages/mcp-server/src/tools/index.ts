...
import update_users_me from './users/me/update-users-me';
import list_accounts_users_me from './users/me/list-accounts-users-me';
...
addEndpoint(update_users_me);
addEndpoint(list_accounts_users_me);
